...
# check to see if dcc5 result is a substring of raw text

# for i in range(2,7702):
#     main_str = str(sheet_result.cell(row=i,column=25).value)
#     sub_str = str(sheet_result.cell(row=i,column=26).value)
#     if main_str.find(sub_str) == -1:
#         sheet_result.cell(row=i,column=27).value = "X"
#     else:
#         sheet_result.cell(row=i,column=27).value = "O"

count_x = 0
count_o = 0
for i in range(2,7702):
    if sheet_result.cell(row=i,column=27).value == "X":
        count_x += 1
    else:
        count_o += 1
