...
# sheet.cell(row=1,column=6).value = 'Google distance'

# sheet.cell(row=1,column=7).value = 'GHTK car distance'
# sheet.cell(row=1,column=8).value = 'GHTK bike distance'
# sheet.cell(row=1,column=9).value = 'GHTK motorcycle distance'
# sheet.cell(row=1,column=10).value = 'GHTK xteam motorcycle distance'

# sheet.cell(row=1,column=11).value = 'Hausdorff distance: GG - GHTK car'
# sheet.cell(row=1,column=12).value = 'Hausdorff distance: GG - GHTK bike'
# sheet.cell(row=1,column=13).value = 'Hausdorff distance: GG - GHTK motorcycle'
# sheet.cell(row=1,column=14).value = 'Hausdorff distance: GG - GHTK xteam motorcycle'

# sheet.cell(row=1,column=15).value = 'Average Hausdorff distance: GG - GHTK car'
# sheet.cell(row=1,column=16).value = 'Average Hausdorff distance: GG - GHTK bike'
# sheet.cell(row=1,column=17).value = 'Average Hausdorff distance: GG - GHTK motorcycle'
# sheet.cell(row=1,column=18).value = 'Average Hausdorff distance: GG - GHTK xteam motorcycle'
