...
# for x in range(2,sheet_obj.max_row+1):
#     sheet_obj.cell(row=x,column=7).value = str(sheet_obj.cell(row=x,column=5).value).count(';') + 1
#     sheet_obj.cell(row=x,column=8).value = str(sheet_obj.cell(row=x,column=6).value).count(';') + 1
