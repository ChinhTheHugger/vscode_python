...
# excel connection
spreadsheet = client.open("C:\\Users\\phams\\Downloads\\failed_case.xlsx")

sheet = spreadsheet.worksheet('failed_case')
...
start = (20.98039,105.78739) # lat, long
end = (21.00814,105.83399) # lat, long

vehicle_type = 'motorcycle'
# vechicle type depends on input data
ghtk_data = ghtk_gh_api(start,end,vehicle_type)

if ghtk_data is not False:
    ghtk_line = LineString(ghtk_data)
else:
